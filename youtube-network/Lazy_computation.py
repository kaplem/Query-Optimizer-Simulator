...
print(len(g.vs))
print(len(g.es))
plot_graph(g, "kk", "output/youtube-graph.png")
...
print
print("--- Time for Influence detection and spread estimation using celf with vertex cover in seconds is  %s   ---" % (time.time() - begin_time))
